...
#------------------------------------------------------------------------------------------
# Os gráficos aparecerão na aba "Plots" no IDE RStudio
if (!require(grDevices)) install.packages("grDevices")
# Essa função fornece controle sobre dispositivos gráficos.
dev.set(1)
...
barplot(table(df$idade), names.arg = lbls, 
        col = c("gray", "red","gray", "green3", "gray", "red"),
        xlab = "Idade dos respondentes", 
        ylim = c(0,max(table(df$idade) + 5)), 
...
#------------------------------------------------------------------------------------------
# Seção 3 do Questionário/Survey
#------------------------------------------------------------------------------------------
...
par(mfrow = c(2, 3)) # comando para colocar três gráficos por linha
...
par(mfrow = c(1, 1)) # retorna ao normal, um gráfico por linha
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

## An easter egg... by Black!
#,,, pie() is rather fun than science...
